...
describe('Dashboard Security', () => {
  ...
  it('should only allow userA to access their dashboard data', async () => {
    ...
    // Should not see each other's data (enforced by backend)
  });

  // Add more tests for privilege escalation and input validation as endpoints expand
}); 
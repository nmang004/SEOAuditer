...
export const SEOScoreBreakdown = React.memo(function SEOScoreBreakdown({
  ...
  return (
    <Card id="score" className="overflow-visible bg-gradient-to-br from-background/80 to-background/30 shadow-lg backdrop-blur-sm border-none">
      ...
      <CardContent>
        <div className="flex flex-col items-center md:flex-row md:items-start md:justify-center gap-8" role="img" aria-label="SEO score breakdown chart" tabIndex={0} aria-describedby="score-breakdown-desc">
          {/* Central Score Circle */}
          <div className="relative flex flex-col items-center justify-center">
            <svg className="w-[150px] h-[150px] -rotate-90" viewBox="0 0 180 180" aria-label="Overall SEO score: {overallScore}" role="img">
              <circle
                cx="90"
                cy="90"
                r={radius}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className={cn('text-5xl font-bold', getScoreColor(overallScore))}>{displayScore}</span>
